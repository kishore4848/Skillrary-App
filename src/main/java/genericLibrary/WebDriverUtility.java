...
/**
 * This class contaings all reusable methods to perform web driver actions
 * @author Kishore
 */
...
/**
 * This methods is used to launch user desired browser
 * @param browser
 * @return
 */
	WebDriver driver;
	...
	/**
	 * This method is to mouse hover on an element
	 * @param element
	 */
	...
	/**
	 * This method is used to select an element drop down based on text
	 * @param text
	 * @param element
	 */
	...
	public void takeScreenshot(WebDriver driver,String className,JavaUtility jutil) {
		...
		File dest=new File("./Screenshot/"+className+"_"+jutil.getCurrntTime()+".png");
		try {
